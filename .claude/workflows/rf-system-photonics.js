...
SETUP: you are in your own git worktree created from master. First run: git checkout --ignore-other-worktrees ${branch} && (npm ci --no-audit --no-fund || npm install --no-audit --no-fund). You may commit fixes by path on this branch. NEVER push.
${RULES}
