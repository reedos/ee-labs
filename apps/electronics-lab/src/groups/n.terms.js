...
export const TERMS_N = {
  oscillator: {
    ...
    def:
      ...
      'its output grows on its own from whatever charge is already on it.',
  },
  barkhausen: {
  ...
  thd: {
    ...
    def:
      ...
      'zero. Counted over the first twelve harmonics, a square wave reads ' +
...
export const MATCH_N = {
  ...
  threshold: /\boscillation threshold\b/i,
  limitcycle: /\blimit cycle\b|\bsteady amplitude\b/i,
  thd: /\btotal harmonic distortion\b|\bTHD\b/i,
