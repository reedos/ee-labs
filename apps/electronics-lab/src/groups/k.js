...
export const currentGainNet = (p) => ({
  elements: [
    ...
    { type: 'I', id: 'Iin', nodes: ['gnd', 'b'], value: 0, small: true },
...
export const dividerNet = (p) => ({
  elements: [
    ...
    { type: 'V', id: 'Vs', nodes: ['s', 'gnd'], value: 0, small: true },
...
export const ceNet = (p) => ({
  elements: [
    ...
    { type: 'V', id: 'Vs', nodes: ['s', 'bb'], value: 0, small: true },
...
function dividerLayout() {
  return {
    ...
    items: [
      ...
      wire(412, 176, 412, 216),
      node('e', 412, 200, 'r'),
      wire(380, 216, 470, 216),
      { el: 'RE', x: 380, y: 236, dir: 'v' },
      { el: 'CE', x: 470, y: 236, dir: 'v' },
      wire(380, 256, 470, 256),
      gnd(425, 256),
