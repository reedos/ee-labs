...
export const TERMS_L = {
  ...
  portresistance: {
    name: 'Port resistance, by test source',
    def:
      'The resistance at a pair of terminals, measured the way it is defined. Kill every source in the circuit, ' +
      'push a known current into one terminal, and divide the voltage that appears by the current. Nothing about ' +
      'the circuit inside has to be known for this to work, dependent sources included.',
  },
  phasemargin: {
    name: 'Phase margin',
    def:
...
export const MATCH_L = {
  ...
  portresistance: /\btest source\b/i,
