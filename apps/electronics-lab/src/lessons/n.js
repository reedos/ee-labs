...
export const LESSONS_N = {
  n1: {
    ...
    why:
      ...
      'the axis and a disturbance decays. Above three they sit right and it grows. The threshold is not exactly ' +
  ...
  n2: {
    ...
    why:
      ...
      'gain sets the shape. At a gain of 3.20 the distortion is 8.65 % and at 4.00 it is 24.1 %. The frequency ' +
