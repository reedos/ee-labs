 ...
 *
 * Circuit Elements Lab's checker, brought over unchanged. This lab hand-placed
 * four schematics without it, and the first screenshots showed what that
 * costs: "Rc 1.8 kΩ" written across "Xm 2.12 H", the load resistor's label off
 * the right edge of the transformer's frame, and the armature's current
 * readings over the word "armature". Every browser probe had passed, because a
 * probe reads the DOM and the DOM was fine. So the geometry is checked as
 * geometry: every text box,
