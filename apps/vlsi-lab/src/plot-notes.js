...
export const PLOT_NOTES = {
  ...
  timing: 'Each row is one logic signal. The upper level is 1 (high). The lower level is 0 (low). Vertical green edges are transitions. Gray vertical lines are time-grid guides.',
