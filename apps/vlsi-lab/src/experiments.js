...
export const EXPERIMENTS = [
  {
    id: 'a1', name: 'An inverter output follows one exponential', view: 'scope', terms: ['switch', 'delay', 'fanout'],
  ...
  {
    id: 'a2', name: 'The transfer curve sets the noise margins', view: 'transfer', terms: ['square', 'margin', 'switch'],
  ...
  {
    id: 'a3', name: 'Transistor delays become a gate model', view: 'timing', terms: ['delay', 'transport'],
  ...
  {
    id: 'a4', name: 'Pull-up width changes resistance and capacitance', view: 'scope', terms: ['self', 'delay'],
  ...
  {
    id: 'a5', name: 'Delay grows linearly with fanout', view: 'fanout', terms: ['fanout', 'self', 'delay'],
