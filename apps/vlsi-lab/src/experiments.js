...
export const EXPERIMENTS = [
  ...
  },
  {
    ...
    foundation: {
      ...
      output: 'The q1, q2 and later traces switch in sequence. Compare the final-stage elapsed delay with the sum of isolated rising and falling delays.',
      ...
      limits: 'Each stage restores an ideal logic level. Events use transport delay rounded to a 1 fs grid. They do not model analog input slopes, pulse filtering or a physically loaded transistor chain.',
    },
