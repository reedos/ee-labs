// The terms Groups A and B need, with the words that mean a reader has met one.
//
// One module per group of the course, merged by ../terms.js. The split is what
// lets a lane that writes a group also write that group's definitions without
// two lanes editing one registry.
//
// The house rules are Signal Lab's. Three or four sentences. The first says what
// the thing is. Concrete numbers over abstraction, and no term defined using an
// undefined term.
