...
//
// The array is in sidebar order, so "n of 21" in the lesson nav is the position
// the reader sees, and experiments.test.js pins that.
//
// The order is DSP_LAB_PLAN.md §5's, over the groups that are built. Groups C, D
// and F are not, so nothing between B and E appears yet, and each of them lands
...
export const EXPERIMENTS = merge([...A, ...B, ...E])
