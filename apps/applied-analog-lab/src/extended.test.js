...
it('has 45 usable lessons with defined symbols and finite endpoint calculations',()=>{
 expect(EXTENDED.map(l=>l.id)).toEqual(['a1','a2','a3','a4','a5','a6','b1','b2','b3','b4','b5','c1','c2','c3','c4','c5','d1','d2','d3','d4','d5','e1','e2','e3','e4','e5','f1','f2','f3','f4','f5','g1','g2','g3','g4','h1','h2','h3','h4','h5','i1','i2','i3','i4','i5'])
