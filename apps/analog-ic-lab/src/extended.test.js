...
it('has seventeen usable foundation, bias and architecture lessons with defined symbols and finite endpoint calculations',()=>{
 expect(EXTENDED.map(l=>l.id)).toEqual(['a1','a2','a3','a4','a5','a6','b1','b2','b3','b4','b5','c1','c2','c3','c4','c5','c6'])
