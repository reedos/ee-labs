// The combinational half's definitions, delivered where the term first does
// work — the suite's pattern (see signal-lab/src/terms.js). Each experiment
// lists the terms its note leans on, and the sidebar offers them folded under
// the note. `../terms.js` merges this with the sequential half's.
//
